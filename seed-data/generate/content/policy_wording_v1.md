...
**Policy Form:** PAP-2024-STD
**Edition Effective Date:** January 1, 2024
**Applies to:** Personal Auto Policies written or renewed on or after the edition effective date, until superseded by a later form edition.
...
1. You, with respect to your covered auto or a non-owned auto.
2. Any resident relative, with respect to your covered auto or a non-owned auto.
3. Any person using your covered auto with your permission.
4. Any person or organization legally responsible for the acts of an insured described above.

### 2.4 Exclusions to Part A

See **Part F, Section 6** for exclusions applicable to all coverage parts, and **Standard Exclusions Addendum PAP-EXCL-2024** for the full list of exclusions specific to Liability Coverage, including racing, intentional acts, and undisclosed business use.
...
The Uninsured/Underinsured Motorist per person and per accident limits shown on the Declarations page apply in the same manner as described for Liability Coverage in Section 2.2. Any amount payable under this Part will be reduced by any amount paid or payable to the insured under any Liability Coverage, Medical Payments Coverage, or workers' compensation law.
...
If the Declarations page shows Comprehensive Coverage applies to your covered auto, we will pay for direct and accidental loss to your covered auto not caused by collision, including but not limited to fire, theft, falling objects, malicious mischief, and glass breakage, less the Comprehensive deductible shown on the Declarations page.

### 5.3 Transportation Expenses

If the Declarations page shows Collision or Comprehensive Coverage applies to your covered auto, we will pay, without application of a deductible, up to the daily and maximum transportation expense limits shown on the Declarations page for temporary transportation expenses incurred by you in the event of a covered loss.
...
1. Promptly notify us of how, when, and where the accident or loss happened, including the names and addresses of any injured persons and witnesses.
2. Cooperate with us in the investigation, settlement, or defense of any claim or suit.
3. Send us copies of any notices or legal papers received in connection with the accident or loss.
4. Submit, as often as we reasonably require, to physical examinations by physicians we select.
5. Authorize us to obtain medical and other relevant records.
6. Submit a proof of loss when required by us.
7. Notify the police promptly if a hit-and-run driver or theft is involved.
...
### 7.3 Section 6 — Exclusions Applicable to All Coverage Parts

The exclusions applicable to all Coverage Parts are set out in the **Standard Exclusions Addendum PAP-EXCL-2024**, which is incorporated into this policy by reference and issued alongside this Policy Wording.

### 7.4 Concealment or Fraud
...
The Company will acknowledge a reported claim within 15 business days of receipt of notice as required under Section 6.1.
...
**Example 1 — Collision claim.** A policyholder with a $500 Collision deductible has $3,200 in estimated Collision damage. Payout = $3,200 − $500 = **$2,700**.

**Example 2 — Comprehensive claim below the deductible.** A policyholder with a $500 Comprehensive deductible has a $480 windshield claim. Because PAP-2024-STD has no glass-only deductible waiver, the standard deductible applies in full. Payout = max($480 − $500, 0) = **$0**. The policyholder is responsible for the full repair cost in this scenario.

**Example 3 — Liability claim.** A policyholder with a $50,000 Property Damage liability limit causes $6,500 in damage to another driver's vehicle. Payout = min($6,500, $50,000) = **$6,500**. No deductible applies to third-party Liability claims.
