...
| *(BR-07+)* | Retrieval, evaluation, multi-agent workflow, realtime/UI, auth, remaining observability (correlation ID, tracing, cost accounting — health/readiness is the only piece BR-05 covers), security, T6 document out | To be added as each is built — see epics in the engineering plan |
